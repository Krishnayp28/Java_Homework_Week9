...
public class Main extends Calculator {
    public static void main(String[] args) {
        ...
        Main obj = new Main();// object declaration to call the parent class method
        char choice = 'Y';
        System.out.println(" The java program to perform the operation between the number");
        do {
            ...
            System.out.println("Would You like to perform more operation ..? Please Enter Y or N in uppercase ");
